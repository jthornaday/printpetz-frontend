...
export const ModelIcon = ({ size = 24, ...props }: IconProps) => {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      />
      <path
        d="M20.3899 10.1299L14.3399 13.1599C13.5899 13.5399 13.1099 14.3099 13.1099 15.1499V20.8699C13.1099 21.6999 13.9799 22.2299 14.7199 21.8599L20.7699 18.8299C21.5199 18.4499 21.9999 17.6799 21.9999 16.8399V11.1199C21.9999 10.2899 21.1299 9.75993 20.3899 10.1299Z"
        fill="currentColor"
      />
    </svg>
  );
