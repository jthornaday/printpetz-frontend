...
export function PremiumHeader() {
  ...
  return <header className="pp-header"><div className="pp-wrap pp-nav">
    ...
    <nav aria-label="Main navigation" className="pp-desktop-nav"><Link href="/#collections">Explore themes</Link><Link href="/#how-it-works">How it works</Link><Link href="/#studio">The studio</Link></nav>
    ...
    {open && <nav id="mobile-navigation" className="pp-mobile-nav" aria-label="Mobile navigation" onClick={() => setOpen(false)}><Link href="/#collections">Explore themes</Link><Link href="/#how-it-works">How it works</Link><Link href="/#studio">The studio</Link><Link href="/login">Sign in</Link></nav>}
  </div></header>;
}
