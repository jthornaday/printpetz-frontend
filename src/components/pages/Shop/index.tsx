...
const products=[{name:"The Everyday Tee",text:"Their personality. Your new favorite outfit.",image:shirt},{name:"The Morning Ritual",text:"Your favorite face, with your favorite coffee.",image:mug},{name:"The Cozy Companion",text:"A little more personality for your favorite corner.",image:pillow}];
