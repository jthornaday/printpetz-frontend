...
function DialogContent({
  ...
  const container =
    typeof window !== "undefined" && parentContainerId
    ...
    <>
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          ...
          !!container
            ? "absolute inset-0 m-auto" // relative to container
            : "fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2", // body
          "z-50 flex flex-col gap-4 rounded-3xl border p-5 shadow-lg",
          "w-14/16 max-w-lg bg-white min-w-2xs drop-shadow-xl",
          className
        )}
        {...props}
      >
